...
public class QuickPayLimitRequest {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QuickPayLimitRequest other = (QuickPayLimitRequest) obj;
		if (auth_token == null) {
	...
	public String toString() {
		return "QuickPayLimitRequest [pref_corp=" + pref_corp + ", auth_token=" + auth_token + ", timeStamp="
				+ timeStamp + "]";
	}
}
